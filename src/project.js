...
function projectsIsEmpty() {
  return Object.keys(Projects).every(
    (project) => Projects[project].length === 0,
  );
}
...
function createDummyData() {
  if (localStorageIsEmpty()) {
    ...
    createProject("Work");
    const tempTodo3 = todo(
      "learn how to write cursive",
      "cursive writing websites",
      "Oct 9th",
      "low",
      9,
    );
    const tempTodo4 = todo("do homework", "on my ipad", "Dec 31st", "high", 10);
    const tempTodo5 = todo(
      "talk to teammates about group project",
      "discord vc",
      "Feb 10th",
      "low",
      11,
